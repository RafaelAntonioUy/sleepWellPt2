...
import 'package:flutter_login/enums/menu_info.dart';
...
class _ClockPageState extends State<ClockPage> {
  ...
  Padding buildMenuButton(String title, IconData icon, VoidCallback onPressed/*Widget page*/) {
    return Padding(
...
class SleepStartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Sleep Start')),
      body: Center(child: Text('Sleep Start Page')),
    );
  }
}
...
class SleepEndPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Sleep End')),
      body: Center(child: Text('Sleep End Page')),
    );
  }
}*/
